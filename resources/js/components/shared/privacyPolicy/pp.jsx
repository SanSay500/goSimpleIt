...
import style from "./pp.module.css";
        ...
        <div className={`${style.main}`}>
            ...
            <SuperSEO
                ...
                openGraph={{
                    ogImage: {
                        ...
                        ogImageAlt: props.seo.OgImageAlt,
                        ogImageWidth: props.seo.OgImageWidth,
                        ogImageHeight: props.seo.OgImageHeight,
                    },
                }}
                twitter={{
                    twitterSummaryCard: {
                        summaryCardImage: props.seo.TwitterSummaryCardImage,
                        summaryCardImageAlt: props.seo.TwitterSummaryCardImage,
                        summaryCardSiteUsername: props.seo.TwitterSummaryCardSiteUsername,
                    },
                }}
            />
            <Header role={props.auth.user && props.auth.user.role}/>
            <br/>
            <h1>Privacy Policy for Go SimpleIT</h1>
            <p>At Go SimpleIT, accessible from https://gosimple.it, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded
                by Go SimpleIT and how we use it.</p>
            <p>If you have additional questions or require more information about our Privacy Policy, do not
                hesitate to contact us. Our Privacy Policy was generated with the help of <a
                    href="https://www.gdprprivacynotice.com/">GDPR Privacy Policy Generator</a></p>
            <h2>General Data Protection Regulation (GDPR)</h2>
            <p>We are a Data Controller of your information.</p>
            <p>Go SimpleIT legal basis for collecting and using the personal information described in this Privacy
                Policy depends on the Personal Information we collect and the specific context in which we collect
                the information:</p>
            <ul>
                <li>Go SimpleIT needs to perform a contract with you</li>
                <li>You have given Go SimpleIT permission to do so</li>
                <li>Processing your personal information is in Go SimpleIT legitimate interests</li>
                <li>Go SimpleIT needs to comply with the law</li>
            </ul>
            <p>Go SimpleIT will retain your personal information only for as long as is necessary for the purposes
            ...
            <h2>Log Files</h2>
            <p>Go SimpleIT follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Like any other website, Go SimpleIT uses 'cookies'. These cookies are used to store information
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Go
                SimpleIT.</p>
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                are used in their respective advertisements and links that appear on Go SimpleIT, which are sent
            ...
            <p>Note that Go SimpleIT has no access to or control over these cookies that are used by third-party
                advertisers.</p>
            <h2>Third Party Privacy Policies</h2>
            <p>Go SimpleIT's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            ...
            <p>Another part of our priority is adding protection for children while using the internet. We encourage
                ...
                activity.</p>
            <p>Go SimpleIT does not knowingly collect any Personal Identifiable Information from children under the
            ...
            <p>Our Privacy Policy applies only to our online activities and is valid for visitors to our website
                with regards to the information that they shared and/or collect in Go SimpleIT. This policy is not
